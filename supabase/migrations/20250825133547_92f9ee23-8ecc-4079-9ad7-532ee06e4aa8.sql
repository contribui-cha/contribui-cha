-- Add reserved_until column to cards table to control 24-hour reservation
ALTER TABLE public.cards 
ADD COLUMN reserved_until TIMESTAMP WITH TIME ZONE;

-- Update the verify_unlock_code_and_reveal function to reserve cards for 24 hours instead of revealing immediately
...
BEGIN
  ...
  -- Get card details
  SELECT id, status, unlock_code, value, guest_email, reserved_until
